<template>
  <div class="max-w-2xl h-full mt-20 mx-auto flex flex-col justify-center items-start">
    ...
    <div class="my-4">
      <p>
        <span class="font-semibold text-[#C21F80] py-1 px-3 bg-slate-300 rounded-md leading-7">Payment</span>  : for sending payment related SMS for Employers  / ለቀጣሪዎች ከክፍያ ጋር ለተያያዘ መልዕክት መላክ ሲይስፈልግ
      </p>
    </div>
