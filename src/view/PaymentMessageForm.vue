...
export default {
  methods: {
    handleButtonClick(action) {
      ...
      switch (action) {
        case 'Well-received':
          message = 'ክፍያውን ስለፈጸሙ እናመሰግናለን። መስፈርትዎን የሚያሟላ የባለሙያ ስልክ ከ15 - 20 ደቂቃ ውስጥ ይደርሶታል። መልካም ቀን!';
          break;
        case 'Reminder':
          message = 'ክፍያ ባለመፈጸምዎ የባለሙያ ጥያቄዎን ለማስተናገድ አልቻልንም። በቀረው 12 ሰዓት ውስጥ ክፍያውን በመፈጸም ፈጣን አገልግሎት ያግኙ። መልካም ቀን!';
          break;
        case 'Closed Ticket':
